...
2. Asked for all 8 scenes with specific factual content baked in per scene (e.g. the AMA citation, the "no pharmacy involved" detail, the staff-hours stat) plus 2 branching choices after every scene
